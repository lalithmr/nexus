      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-32 mb-20 md:mb-80 items-center md:items-end text-center lg:text-left">
          <div className="lg:col-span-9 w-full">
             ...
             <h2 className="text-6xl md:text-8xl lg:text-[12rem] titanium-gradient leading-[0.75] tracking-[-0.1em] italic">
               Measureable <br/> 
          ...
          {metrics.map((metric, i) => (
            ...
            >
              ...
              <div className="space-y-2 md:space-y-4">
                <span className="text-5xl md:text-7xl lg:text-[7rem] font-light text-titanium block tracking-[-0.08em] group-hover:italic transition-all duration-1000">
                  {metric.value}
                </span>
                <AnimatePresence>
                  {focus === i && (
