  ...
  return (
    <section id="results" className="py-20 md:py-40 bg-carbon relative overflow-hidden border-t border-titanium/5 grid-pattern">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-32 mb-20 md:mb-80 items-center md:items-end text-center lg:text-left">
          ...
          <div className="lg:col-span-3 w-full">
             <div className="space-y-6 md:space-y-8 border-l border-titanium/10 pl-6 md:pl-10">
                <p className="text-lg md:text-xl font-light text-titanium/70 italic leading-tight">
        ...
        <div className="grid grid-cols-2 gap-px bg-titanium/5 max-w-5xl mx-auto">
          {metrics.map((metric, i) => (
            <motion.div 
              ...
              className="bg-base p-6 md:p-10 lg:p-14 flex flex-col justify-between aspect-square group cursor-crosshair transition-all duration-1000 border border-transparent hover:border-titanium/5"
            >
              <div className="flex justify-between items-start gap-2">
                <span className="text-[10px] md:text-xs font-mono tracking-[0.2em] opacity-50 uppercase group-hover:text-titanium transition-colors truncate">/{metric.label}</span>
                <span className="text-[10px] md:text-xs font-mono text-bronze opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">[{metric.status}]</span>
              </div>
              <div className="space-y-2 md:space-y-4">
                <span className="text-4xl md:text-5xl lg:text-5xl xl:text-[5rem] font-light text-titanium block tracking-[-0.08em] group-hover:italic transition-all duration-1000 truncate">
                  {metric.value}
                </span>
                <AnimatePresence>
                  {focus === i && (
                    <motion.p 
                      ...
                      exit={{ opacity: 0, y: 5 }}
                      className="text-[10px] md:text-xs font-mono tracking-[0.1em] text-titanium/90 uppercase"
                    >
                      {metric.detail}
                    </motion.p>
                  )}
        ...
        <div className="mt-20 md:mt-80 pt-20 md:pt-80 border-t border-titanium/5 grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-32">
          <div className="lg:col-span-4 flex flex-col justify-between items-start">
             ...
             <p className="text-[9px] md:text-[10px] text-titanium/50 uppercase tracking-[0.4em] mb-8 font-mono max-w-xs"> Trusted by growing businesses to scale smarter. </p>
          ...
          <div className="lg:col-span-8 flex flex-col gap-12 md:gap-32">
             <motion.blockquote 
               ...
               className="text-2xl md:text-3xl lg:text-5xl font-light text-titanium/80 leading-tight italic tracking-[-0.06em] group"
             >
             ...
             <motion.blockquote 
               ...
               className="text-2xl md:text-3xl lg:text-5xl font-light text-titanium/80 leading-tight italic tracking-[-0.06em] group border-t border-titanium/5 pt-12"
             >
